package com.gallop.mybatis.interceptor.utils;
...
public class MybatisInterceptorConfig {
    ...
    public MybatisInterceptorConfig(Class<?> modelClass, String attrName) {
        ...
        //this.interceptorClass = SM4Utils.class.getName();
        //this.interceptorMethod = "encryptData_ECB";
        //this.undoClass = SM4Utils.class.getName();
        //this.undoMethod = "decryptData_ECB";
    }
